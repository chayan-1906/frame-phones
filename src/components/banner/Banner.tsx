            ...
            <div className={'container py-14 grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-x-0 gap-12'}>
                ...
                <div className={'flex flex-col justify-center'}>
                    <div className={'text-center md:text-left space-y-4 lg:max-w-[450px]'}>
                        <motion.h1 variants={fadeUp(0.7)} initial={'hidden'} whileInView={'show'} className={'text-3xl lg:text-4xl font-semibold font-poppins'}>The Latest Headphones with the latest
                            technology
                        </motion.h1>
                        <motion.p variants={fadeUp(0.9)} initial={'hidden'} whileInView={'show'} className={''}>
                        ...
                        <motion.button variants={fadeUp(1.3)} initial={'hidden'} whileInView={'show'}
